...
<div class="forpadding" style="padding-bottom: 1000px;">

<div class="sc_box menu" style="padding-bottom : 100px;"><h3>리뷰 수정하기  </h3>
<br />


<form action="modify2.do?no=${modReq.articleNumber }" method="post" enctype="multipart/form-data"  >
...
<div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="title" id="input1" value="${modReq.title }" required>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="content" id="textarea1" rows="3">${modReq.content }</textarea>
  </div>
